...
We utilize Rust's aliasing restriction to design a monadic shallow embedding of a
substantial subset of Rust
into the purely functional language of the Lean theorem prover without the need
for any heap-like indirection or an explicit memory model. This allows us to
reason about unannotated, real-world Rust code in the same manner one would
...
\texttt{fixedbitset} crate.\todo{I have no idea where to put the complexity analysis}